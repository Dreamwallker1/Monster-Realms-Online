...
export const MYTH_ARCHETYPE: Record<string, ArchetypeName> = {
  // Fire
  'cinder-pup':'FireWolf',   'magmar-wolf':'FireWolf',  'torch-kit':'FireWolf',
  'volcanus':'FireWolf',     'pyro-titan':'FireWolf',
  'flame-wisp':'FireSpirit', 'blaze-sprite':'FireSpirit','scorch-moth':'FireSpirit',
  'inferno-bat':'FireSpirit','cinder-phoenix':'FireSpirit','ignis-seraph':'FireSpirit',
  'ash-lizard':'FireDrake',  'char-wyvern':'FireDrake', 'lava-serpent':'FireDrake',
  'magma-basilisk':'FireDrake','helios-wyrm':'FireDrake',
  'ember-crab':'FireGolem',  'forge-golem':'FireGolem', 'scorched-mantis':'FireGolem',
  'pyro-toad':'FireGolem',
  // Water
  'brook-turtle':'WaterTurtle','aqua-guardian':'WaterTurtle','sea-golem':'WaterTurtle',
  'tide-colossus':'WaterTurtle','ocean-titan':'WaterTurtle','storm-crab':'WaterTurtle',
  'tide-pup':'WaterCanine',  'surge-hound':'WaterCanine','stream-otter':'WaterCanine',
  'wave-imp':'WaterCanine',  'reef-hatchling':'WaterCanine','puddle-toad':'WaterCanine',
  'mist-jellyfish':'SeaJelly','coral-sprite':'SeaJelly', 'thalassa-deity':'SeaJelly',
  'abyssal-eel':'SeaSerpent','deep-ray':'SeaSerpent',    'tempest-leviathan':'SeaSerpent',
  'abyss-wyrm':'SeaSerpent', 'poseidon-serpent':'SeaSerpent',
  // Nature
  'ancient-treant':'Treant', 'verdant-titan':'Treant',  'thorn-colossus':'Treant',
  'briar-golem':'Treant',
  'seed-sprite':'VineSprite','sprout-sprite':'VineSprite','bloom-guardian':'VineSprite',
  'earthmother':'VineSprite','sylvan-deity':'VineSprite','gaia-wyrm':'VineSprite',
  'vine-pup':'NatureWolf',   'thorn-wolf':'NatureWolf', 'canopy-serpent':'NatureWolf',
  'leaf-ferret':'ForestBeast','moss-crab':'ForestBeast','petal-bee':'ForestBeast',
  'root-mole':'ForestBeast', 'fern-hatchling':'ForestBeast','grove-hawk':'ForestBeast',
  'spore-bat':'ForestBeast',
  // Electric
  'lightning-hawk':'ThunderHawk','storm-bat':'ThunderHawk','galvanos':'ThunderHawk',
  'arc-leviathan':'ThunderHawk','thunder-deity':'ThunderHawk','zeus-wyrm':'ThunderHawk',
  'spark-kit':'LightningFox','charge-pup':'LightningFox','thunder-wolf':'LightningFox',
  'tempest-titan':'LightningFox','jolt-lizard':'LightningFox',
  'plasma-ray':'ElectricRay','storm-serpent':'ElectricRay','zap-moth':'ElectricRay',
  'buzz-bee':'ElectricRay',  'static-crab':'ElectricRay',
  'arc-golem':'StormGolem',  'storm-colossus':'StormGolem','arc-sprite':'StormGolem',
  'volt-hatchling':'StormGolem',
  // Dark
  'void-stalker':'ShadowCat','void-titan':'ShadowCat',  'void-deity':'ShadowCat',
  'shadow-imp':'ShadowCat',  'dusk-ferret':'ShadowCat',
  'gloom-wisp':'VoidWraith', 'nightmare-specter':'VoidWraith','abyssal-wraith':'VoidWraith',
  'dark-sprite':'VoidWraith','shade-hatchling':'VoidWraith','erebus-entity':'VoidWraith',
  'shadow-bat':'DarkBird',   'umbra-moth':'DarkBird',   'eclipse-hawk':'DarkBird',
  'shadow-leviathan':'DarkBird',
  'night-crab':'ShadowGolem','murk-toad':'ShadowGolem', 'dusk-serpent':'ShadowGolem',
  'gloom-golem':'ShadowGolem','dark-colossus':'ShadowGolem',
};
